...
export const armorer_features_en: GameLocalizationCategory = {
  tools_of_the_trade: {
  ...
  perfected_armor: {
    ...
    description: `Your Arcane Armor gains additional benefits based on its model, as shown below.
