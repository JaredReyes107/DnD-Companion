...
export const glory_features_en: GameLocalizationCategory = {
  tenets_of_glory: {
    name: "Tenets of Glory",
    description:
      "The tenets of the Oath of Glory drive a paladin to attempt heroics that might one day shine in legend. Strive to be known by glorious deeds, not words. Face hardships with courage, and encourage your allies to face them with you. Like raw stone, your body must be worked so its potential can be realized. You must marshal the discipline to overcome failings within yourself that threaten to dim the glory of you and your friends.",
  },
  oath_spells_glory: {
    name: "Oath Spells",
    description:
  ...
  channel_divinity_glory: {
    ...
    description: `You gain the following two Channel Divinity options. See the Sacred Oath class feature for how Channel Divinity works:
    ...
    - Inspiring Smite: Inmediately after you deal damage to a creature with your Divine Smite feature, you can use your Channel Divinity as a bonus action and distribute temporary hit points to creatures of your choice within 30 feet of you, which can include you. The total number of temporary hit points equals 2d8 + your level in this class, divided among the chosen creatures however you like.`,
  },
  aura_of_alacrity: {
