...
export const assassin_features_en: GameLocalizationCategory = {
  bonus_proficiencies: {
  ...
  death_strike: {
    name: "Death Strike",
    description:
      "You become a master of instant death. When you attack and hit a creature that is surprised, it must make a Constitution saving throw (8 + your Dexterity modifier + your proficiency bonus). On a failed save, double the damage of your attack against the creature.",
  },
};
