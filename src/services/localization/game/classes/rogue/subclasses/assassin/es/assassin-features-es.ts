...
export const assassin_features_es: GameLocalizationCategory = {
  bonus_proficiencies: {
  ...
  assassinate: {
    name: "Asesinar",
    description:
      "Eres especialmente mortífero cuando consigues sorprender a tus enemigos. Tienes ventaja en las tiradas de ataque contra cualquier criatura que aún no haya llevado a cabo ningún turno en el combate actual. Además, cualquier impacto contra una criatura sorprendida será automáticamente un crítico.",
  },
