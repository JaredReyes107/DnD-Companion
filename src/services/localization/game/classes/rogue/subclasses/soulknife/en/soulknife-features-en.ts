...
export const soulknife_features_en: GameLocalizationCategory = {
  psionic_power: {
    name: "Psionic Power",
  ...
  soul_blades: {
    name: "Soul Blades",
    description: `Your Psychic Blades are now an expression of your psi-suffused soul, giving you these powers that use your Psionic Energy dice:
