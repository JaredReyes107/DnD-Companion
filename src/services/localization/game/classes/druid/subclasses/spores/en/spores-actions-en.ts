...
export const spores_actions_en: GameLocalizationCategory = {
  ...
  spreading_spores_deactivate: {
    ...
    description: "You can dismiss the spores early as a bonus action. They also dissapear if your Symbiotic Entity feature is no longer active.",
  },
};
