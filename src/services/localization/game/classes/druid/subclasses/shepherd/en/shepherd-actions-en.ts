...
export const shepherd_actions_en: GameLocalizationCategory = {
    ...
    description: "You magically summon an incorporeal spirit to a point you can see within 60 feet of you. The spirit creates an aura in a 30-foot radius around that point. It counts as neither a creature nor an object, though it has the spectral appearance of the creature it represents. The spirit persists for 1 minute or until you're incapacitated.",
  },
  spirit_totem_move: {
