...
combat_wild_shape_transform: {
  ...
  combat_wild_shape_heal: {
    ...
    description: "While you are transformed by Wild Shape, you can expend one spell slot to regain 1d8 hit points per level of the spell slot expended.",
  },
  elemental_wild_shape: {
    name: "Elemental Wild Shape",
    description: "You transform into an air elemental, an earth elemental, a fire elemental, or a water elemental.",
  },
  thousand_forms: {
    name: "Thousand Forms",
