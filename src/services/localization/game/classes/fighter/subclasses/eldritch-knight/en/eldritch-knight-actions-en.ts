...
export const eldritch_knight_actions_en: GameLocalizationCategory = {
  weapon_bond: {
    name: "Weapon Bond",
  ...
  arcane_charge: {
    name: "Arcane Charge",
    description: `You teleport up to 30 feet to an unoccupied space you can see when you use your Action Surge. You can teleport before or after the additional action.`,
  },
  improved_war_magic: {
