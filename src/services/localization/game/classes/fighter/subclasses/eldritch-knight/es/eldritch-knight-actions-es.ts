...
export const eldritch_knight_actions_es: GameLocalizationCategory = {
  weapon_bond: {
  ...
  war_magic: {
    ...
    description: `Realizas un ataque con un arma como acción adicional después usar tu acción para lanzar un truco.`,
  },
  eldritch_strike: {
    name: "Golpe Sobrenatural",
    description: `Cuando golpeas a una criatura con un ataque con arma, dicha criatura tiene desventaja en la siguiente tirada de salvación que realice en contra de un conjuro que lances antes del final de tu siguiente turno.`,
  },
  arcane_charge: {
    name: "Carga arcana",
    description: `Te teletransportas con tu Acción Súbita a un espacio desocupado que esté hasta a 30 pies de distancia y que puedas ver. Puedes teletransportarte antes o después de la acción adicional.`,
  },
  improved_war_magic: {
    name: "Magia de Batalla Mejorada",
    description: `Realizas un ataque con arma como acción adicional después de usar tu acción para lanzar un conjuro.`,
  },
};
