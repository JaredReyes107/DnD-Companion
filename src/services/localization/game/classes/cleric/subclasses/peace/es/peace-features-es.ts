...
export const peace_features_es: GameLocalizationCategory = {
  ...
  expansive_bond: {
    ...
    description:
      "Los beneficios de tus rasgos Vínculo Incentivador y Vínculo Protector ahora funcionan cuando las criaturas se encuentran a 60 pies o menos unas de otras. Además, cuando una criatura utilice Vínculo Protector para recibir el daño de otra, tendrá resistencia a ese daño.",
  },
};
