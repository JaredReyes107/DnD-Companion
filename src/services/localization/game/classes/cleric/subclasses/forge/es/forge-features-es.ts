...
export const forge_features_es: GameLocalizationCategory = {
  ...
  soul_of_the_forge: {
    ...
    description: "Tu maestría con la forja te proporciona habilidades especiales: Ganas resistencia al fuego. Además, recibes un bonificador de +1 a la Clase de Armadura cuando lleves armadura pesada.",
  },
  divine_strike: {
    name: "Golpe Divino",
    description: "Obtienes la capacidad de infundir los golpes de tu arma con el fiero poder de la forja. una vez en cada uno de tus turnos, cuando impactes a una criatura con un ataque con arma, puedes hacer que dicho ataque cause 1d8 de daño de fuego adicional al objetivo. Cuando llegas a nivel 14, este daño adicional pasa a ser 2d8.",
  },
  saint_of_forge_and_fire: {
    name: "Santo de la Forja y el Fuego",
    description: "Tu afinidad sagrada con el fuego y el metal se vuelve más poderosa: Ganas inmunidad al daño de fuego. Además, mientras lleves armadura pesada, tienes resistencia al daño contundente, cortante y perforante de ataques no mágicos.",
  },
};
