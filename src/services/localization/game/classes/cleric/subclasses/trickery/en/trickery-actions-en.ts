...
export const trickery_actions_en: GameLocalizationCategory = {
blessing_of_the_trickster: {
    name: "Blessing of the Trickster",
    description: "You touch a willing creature other than yourself to give it advantage on Dexterity (Stealth) checks. This blessing lasts for 1 hour or until you use this feature again.",
  },
