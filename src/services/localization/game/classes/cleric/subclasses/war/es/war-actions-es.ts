...
export const war_actions_es: GameLocalizationCategory = {
  ...
  channel_divinity_guided_strike: {
    name: "Impacto Guiado",
    description:
      "Cuando realices una tirada de ataque, puedes usar tu Canalizar Divinidad para ganar un bonificador de +10 a la tirada. Haces esta elección después de ver la tirada, pero antes de que el DM diga si el ataque acierta o falla.",
  },
  channel_divinity_war_gods_blessing: {
    name: "Bendición de Guerra",
    description:
