...
export const war_features_es: GameLocalizationCategory = {
  ...
  divine_strike: {
    name: "Golpe Divino",
    description: "Ganas la habilidad de infundir de energía divina tus golpes con armas. Una vez por turno, cuando golpees a una criatura con un ataque con armas puedes hacer que el ataque cause daño adicional del mismo tipo que causa el arma al objetivo",
  },
  avatar_of_battle: {
    name: "Avatar de Batalla",
    description: "Ganas resistencia al daño contundente, perforante y cortante de las armas no mágicas",
  },
};
