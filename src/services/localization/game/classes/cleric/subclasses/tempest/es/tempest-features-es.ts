...
export const tempest_features_es: GameLocalizationCategory = {
  ...
  bonus_proficiencies: {
    ...
    description: "Ganas competencia con las armas marciales y armaduras pesadas.",
  },
  wrath_of_the_storm: {
  ...
  channel_divinity_destructive_wrath: {
    ...
    description: "Puedes utilizar tu Canalizar Divinidad para empuñar el poder de la tormenta con furia desmedida. Cuando tires para determinar la cantidad de daño de relámpago o trueno que causas, podrás usar tu Canalizar Divinidad para hacer el daño máximo en vez de tirar los dados.",
  },
  thunderbolt_strike: {
    name: "Golpe Tempestuoso",
    description: "A partir de nivel 6, cuando causes daño de relámpago a una criatura Grande o más pequeña, también puedes empujarla hasta 10 pies en la dirección opuesta a ti.",
  },
  divine_strike: {
    name: "Golpe Divino",
    description: "Tienes la capacidad para imbuir los golpes de tu arma con energía divina. Una vez en cada uno de tus turnos, cuando impactes a una criatura con un ataque con arma, puedes hacer que dicho ataque cause de daño de trueno adicional al objetivo.",
  },
  stormborn: {
    name: "Hijo de la Tormenta",
    description: "Tienes velocidad de vuelo equivalente a tu actual velocidad caminando, siempre que no estés en interiores o bajo tierra.",
  },
};
