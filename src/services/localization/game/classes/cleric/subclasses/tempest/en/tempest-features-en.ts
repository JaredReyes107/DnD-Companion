...
export const tempest_features_en: GameLocalizationCategory = {
  ...
  channel_divinity_destructive_wrath: {
    ...
    description: "Yu can use your Channel Divinity to wield the power of the storm with unchecked ferocity. When you roll lightning or thunder damage, you can use your Channel Divinity to deal maximum damage, instead of rolling.",
  },
  thunderbolt_strike: {
