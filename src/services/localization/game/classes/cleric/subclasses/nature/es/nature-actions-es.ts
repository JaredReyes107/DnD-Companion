...
export const nature_actions_es: GameLocalizationCategory = {
    ...
    master_of_nature: {
        ...
        description: "Mientras las criaturas estén encantadas por tu rasgo Hechizar Animales y Plantas, puedes usar una acción adicional en tu turno para ordenar verbalmente a cada una de esas criaturas qué hacer en el turno siguiente.",
    },
};
