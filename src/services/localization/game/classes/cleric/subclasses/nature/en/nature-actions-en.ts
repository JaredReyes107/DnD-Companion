...
export const nature_actions_en: GameLocalizationCategory = {
    ...
    master_of_nature: {
        ...
        description: "While creatures are charmed by your Charm Animals and Plants feature, you can take a bonus action on your turn to verbally command what each of those creatures will do on its next turn.",
    },
};
