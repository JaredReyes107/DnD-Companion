...
export const twilight_actions_en: GameLocalizationCategory = {
  eyes_of_night: {
    name: "Eyes of Night",
    description:
      "You can magically share the darkvision of this feature with willing creatures you can see within 10 feet of you, up to a number of creatures equal to your Wisdom modifier (minimum of one creature). The shared darkvision lasts for 1 hour.",
  },
  vigilant_blessing: {
  ...
  steps_of_night: {
    name: "Steps of Night",
    description:
      "When you are in dim light or darkness, you can magically give yourself a flying speed equal to your walking speed for 1 minute.",
  },
};
