  ...
  featuresByLevel: {
    1: [
      ...
      },
      {
        ...
        source: "subclass" as const,
        level: 1,
        grants: [{ type: "action", id: "blessing_of_the_trickster" }],
    ...
    2: [
      {
        ...
        level: 2,
        grants: [
          { type: "action", id: "channel_divinity_invoke_duplicity" },
          { type: "action", id: "channel_divinity_invoke_duplicity" },
        ],
    ...
    6: [
      {
        ...
        source: "subclass" as const,
        level: 6,
        grants: [{ type: "action", id: "channel_divinity_cloak_of_shadows" }],
