  ...
  featuresByLevel: {
    1: [
      ...
      },
      {
        ...
        source: "subclass" as const,
        level: 1,
        grants: [{ type: "action", id: "eyes_of_the_grave"}, { type: "resource", id: "eyes_of_the_grave"}],
        tags: ["utility", "senses"],
      },
    ],
    ...
    2: [
      {
        ...
        source: "subclass" as const,
        level: 2,
        grants: [{ type: "action", id: "channel_divinity_path_to_the_grave"}],
    ...
    6: [
      {
        ...
        source: "subclass" as const,
        level: 6,
        grants: [{ type: "action", id: "sentinel_at_deaths_door"}, { type: "resource", id: "sentinel_at_deaths_door"}],
