    ...
    3: [
      {
        ...
        source: "subclass",
        level: 3,
        description: `You learn three maneuvers of your choice which are fueled by superiority dice. You can use only one maneuver per attack. You learn two addicional maneuvers at 7th and 15th level.
      ...
      },
      {
        ...
        level: 3,
        description:
          "At 3rd level, you gain proficiency with one type or artisan's tools of your choice",
      },
    ],
    ...
    7: [
      {
        ...
        source: "subclass",
        level: 7,
        description: `You can learn certain information about a creature if you spend at least 1 minute observing or interacting with it outside of combat. The DM tells you wheter the creature is your equal, supperior or inferior in  regard to two of the following characteristics:
    ...
    15: [
      {
        ...
        level: 15,
        description:
          "When you roll for initiative and have no superiority dice remaining, you regain 1 superiorty die",
        tags: ["passive", "combat"],
      },
    ],
