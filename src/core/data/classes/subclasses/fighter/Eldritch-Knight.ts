    ...
    3: [
      {
        ...
        level: 3,
        description:
          `You can perform a ritual over the course of 1 hour to bond with a weapon. The ritual can be perfomed as part of a short or long rest.
    ...
    10: [
      {
        ...
        source: "subclass",
        level: 10,
        description: "When you hit a creature with a weapon attack, that creature hast disadvantage on the next saving throw it makes against a spell you cast before the end of your next turn.",
        tags: ["passive"],
      },
    ],
    ...
    15: [
      {
        ...
        source: "subclass",
        level: 15,
        description: "You teleport up to 30 ft. to an unocuppied space you can see when you use Action Surge. You can teleport before or after the additional action",
