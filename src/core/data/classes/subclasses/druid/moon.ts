    ...
    2: [
      {
        ...
        level: 2,
        grants: [
          { type: "action", id: "combat_wild_shape_heal" },
          { type: "action", id: "combat_wild_shape_transform" },
        ],
    ...
    10: [
      {
        ...
        source: "subclass" as const,
        level: 10,
        grants: [{ type: "action", id: "elemental_wild_shape" }],
        tags: ["transformation"],
      },
    ],
    ...
    14: [
      {
        ...
        source: "subclass" as const,
        level: 14,
        grants: [{ type: "action", id: "thousand_forms" }],
