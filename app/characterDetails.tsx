            ...
            <View style={styles.mainStatContainer}>            
              <View style={styles.mainStatBox}>
                <View style={styles.mainStatModifierContainer}>
                  ...
                  <Text style={styles.mainStatModifierValue}>{((character?.StatModifiers[0] ? character?.StatModifiers[0] : 0) > 0 ? "+" : "") + character?.StatModifiers[0]}</Text>
                </View>
                <View style={styles.mainStatValueContainer}>
                  <Text style={styles.mainStatValue}>{character?.Stats[0]}</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.mainStatContainer}>            
              <View style={styles.mainStatBox}>
                <View style={styles.mainStatModifierContainer}>
                  ...
                  <Text style={styles.mainStatModifierValue}>{((character?.StatModifiers[1] ? character?.StatModifiers[1] : 0) > 0 ? "+" : "") + character?.StatModifiers[1]}</Text>
                </View>
                <View style={styles.mainStatValueContainer}>
                  <Text style={styles.mainStatValue}>{character?.Stats[1]}</Text>
                </View>
              </View>
            </View>
              ...
              <View style={styles.mainStatBox}>
                <View style={styles.mainStatModifierContainer}>
                  <Text style={styles.mainStatText}>CON</Text>
                    <Text style={styles.mainStatModifierValue}>{((character?.StatModifiers[2] ? character?.StatModifiers[2] : 0) > 0 ? "+" : "") + character?.StatModifiers[2]}</Text>
                </View>
                <View style={styles.mainStatValueContainer}>
                  <Text style={styles.mainStatValue}>{character?.Stats[2]}</Text>
                </View>
              </View>
            </View>    
              ...
              <View style={styles.mainStatBox}>
                <View style={styles.mainStatModifierContainer}>
                  <Text style={styles.mainStatText}>INT</Text>
                    <Text style={styles.mainStatModifierValue}>{((character?.StatModifiers[3] ? character?.StatModifiers[3] : 0) > 0 ? "+" : "") + character?.StatModifiers[3]}</Text>
                </View>
                <View style={styles.mainStatValueContainer}>
                  <Text style={styles.mainStatValue}>{character?.Stats[3]}</Text>
                </View>
              </View>
            </View>   
              ...
              <View style={styles.mainStatBox}>
                <View style={styles.mainStatModifierContainer}>
                  <Text style={styles.mainStatText}>SAB</Text>
                    <Text style={styles.mainStatModifierValue}>{((character?.StatModifiers[4] ? character?.StatModifiers[4] : 0) > 0 ? "+" : "") + character?.StatModifiers[4]}</Text>
                </View>
                <View style={styles.mainStatValueContainer}>
                  <Text style={styles.mainStatValue}>{character?.Stats[4]}</Text>
                </View>
              </View>
            </View>
              ...
              <View style={styles.mainStatBox}>
                <View style={styles.mainStatModifierContainer}>
                  <Text style={styles.mainStatText}>CAR</Text>
                    <Text style={styles.mainStatModifierValue}>{((character?.StatModifiers[5] ? character?.StatModifiers[5] : 0) > 0 ? "+" : "") + character?.StatModifiers[5]}</Text>
                </View>
                <View style={styles.mainStatValueContainer}>
                  <Text style={styles.mainStatValue}>{character?.Stats[5]}</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.secondaryStatContainer}>            
              <View style={styles.secondaryStatBox}>
                <View style={styles.secondaryStatModifier}>
                  ...
                  <Text style={styles.secondaryStatModifierValue}>{((character?.InitiativeBonus ? character?.InitiativeBonus : 0) > 0 ? "+" : "") + character?.InitiativeBonus}</Text>
                </View>
              </View>
            </View>
            ...
            <View style={styles.secondaryStatContainer}>            
              <View style={styles.secondaryStatBox}>
                <View style={styles.secondaryStatModifier}>
                  ...
                  <Text style={styles.secondaryStatModifierValue}>{character?.Speed}</Text>
            ...
            <View style={styles.secondaryStatContainer}>            
              <View style={styles.secondaryStatBox}>
                <View style={styles.secondaryStatModifier}>
                  ...
                  <Text style={styles.secondaryStatModifierValue}>{character?.ArmorClass}</Text>
        ...
        <View style={styles.detailsSection}>
            ...
            <View style={styles.proficiencyRow}>
              <View style={styles.proficiencyDetails}>
                {!(character?.SavingThrowsProficiencies[0]) && (
                  <MaterialIcons name="radio-button-unchecked" size={14} color="#cccccc"></MaterialIcons>
                )}
                {character?.SavingThrowsProficiencies[0] && (
                  <MaterialIcons name="circle" size={14} color="#cccccc"></MaterialIcons>
                )}
                <Text style={styles.proficiencyText}>Fuerza</Text>
              </View>
              <Text style={styles.proficiencyModifierBold}>{((character?.SavingThrowModifiers[0] ? character?.SavingThrowModifiers[0] : 0) > 0 ? "+" : "") + character?.SavingThrowModifiers[0]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifierBold}>{((character?.SavingThrowModifiers[1] ? character?.SavingThrowModifiers[1] : 0) > 0 ? "+" : "") + character?.SavingThrowModifiers[1]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifierBold}>{((character?.SavingThrowModifiers[2] ? character?.SavingThrowModifiers[2] : 0) > 0 ? "+" : "") + character?.SavingThrowModifiers[2]}</Text>
            </View>
          </View>    
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifierBold}>{((character?.SavingThrowModifiers[3] ? character?.SavingThrowModifiers[3] : 0) > 0 ? "+" : "") + character?.SavingThrowModifiers[3]}</Text>
            </View>
          </View>   
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifierBold}>{((character?.SavingThrowModifiers[4] ? character?.SavingThrowModifiers[4] : 0) > 0 ? "+" : "") + character?.SavingThrowModifiers[4]}</Text>
            </View>
          </View>    
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifierBold}>{((character?.SavingThrowModifiers[5] ? character?.SavingThrowModifiers[5] : 0) > 0 ? "+" : "") + character?.SavingThrowModifiers[5]}</Text>
            </View>
          </View>   
        </View>
        ...
        <View style={styles.detailsSection}>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[0] ? character?.SkillModifiers[0] : 0) > 0 ? "+" : "") + character?.SkillModifiers[0]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[1] ? character?.SkillModifiers[1] : 0) > 0 ? "+" : "") + character?.SkillModifiers[1]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[2] ? character?.SkillModifiers[2] : 0) > 0 ? "+" : "") + character?.SkillModifiers[2]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[3] ? character?.SkillModifiers[3] : 0) > 0 ? "+" : "") + character?.SkillModifiers[3]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[4] ? character?.SkillModifiers[4] : 0) > 0 ? "+" : "") + character?.SkillModifiers[4]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[5] ? character?.SkillModifiers[5] : 0) > 0 ? "+" : "") + character?.SkillModifiers[5]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[6] ? character?.SkillModifiers[6] : 0) > 0 ? "+" : "") + character?.SkillModifiers[6]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[7] ? character?.SkillModifiers[7] : 0) > 0 ? "+" : "") + character?.SkillModifiers[7]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[8] ? character?.SkillModifiers[8] : 0) > 0 ? "+" : "") + character?.SkillModifiers[8]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[9] ? character?.SkillModifiers[9] : 0) > 0 ? "+" : "") + character?.SkillModifiers[9]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[10] ? character?.SkillModifiers[10] : 0) > 0 ? "+" : "") + character?.SkillModifiers[10]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[11] ? character?.SkillModifiers[11] : 0) > 0 ? "+" : "") + character?.SkillModifiers[11]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[12] ? character?.SkillModifiers[12] : 0) > 0 ? "+" : "") + character?.SkillModifiers[12]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[13] ? character?.SkillModifiers[13] : 0) > 0 ? "+" : "") + character?.SkillModifiers[13]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[14] ? character?.SkillModifiers[14] : 0) > 0 ? "+" : "") + character?.SkillModifiers[14]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[15] ? character?.SkillModifiers[15] : 0) > 0 ? "+" : "") + character?.SkillModifiers[15]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[16] ? character?.SkillModifiers[16] : 0) > 0 ? "+" : "") + character?.SkillModifiers[16]}</Text>
            </View>
          </View>
          ...
          <View style={styles.proficienciesContainer}>
            <View style={styles.proficiencyRow}>
              ...
              <Text style={styles.proficiencyModifier}>{((character?.SkillModifiers[17] ? character?.SkillModifiers[17] : 0) > 0 ? "+" : "") + character?.SkillModifiers[17]}</Text>
            </View>
          </View>
        </View>
