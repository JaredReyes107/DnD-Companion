...
const SUB_ACTIONS_OUT = path.resolve(
  __dirname,
  "../../src/core/data/actions/by-subclass",
);
const SUB_RESOURCES_OUT = path.resolve(
  __dirname,
  "../../src/core/data/rules/resources",
);
