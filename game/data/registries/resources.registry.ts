import { BASE_RESOURCES } from "@/game/data/base/resources";
import {
  ResourceCategory,
  ResourceTemplate,
} from "../templates/resource-template";
import { ResourceInstance } from "../../domain/resources/resource-instance";
import { CharacterResources } from "../../domain/resources/character-resources";
import { SPELL_SLOTS } from "../base/resources/spell-slots";
